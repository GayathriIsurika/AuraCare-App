...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  void _getBotReply(String userMessage) {
    ...
    if (msg.contains('hello') || msg.contains('hi')) {
      ...
      reply =
          'For a fever, it is important to stay hydrated, rest, and keep cool. You may use over-the-counter fever reducers if appropriate.$disclaimer';
    } else if (msg.contains('headache') ||
        msg.contains('migraine') ||
        msg.contains('head')) {
      reply =
          'For a headache, rest in a quiet, dark room, stay hydrated, and apply a cool compress to your forehead.$disclaimer';
    } else if (msg.contains('cough') ||
        msg.contains('cold') ||
        msg.contains('flu')) {
      reply =
          'For a cough or cold, drink warm fluids, use a humidifier, and get plenty of rest.$disclaimer';
    } else if (msg.contains('stomach') ||
        msg.contains('pain') ||
        msg.contains('nausea')) {
      reply =
          'For stomach pain, try sipping clear liquids, eating bland foods (like crackers or toast), and resting.$disclaimer';
    } else if (msg.contains('diet') ||
        msg.contains('nutrition') ||
        msg.contains('food')) {
      reply =
          'For a healthy diet, focus on eating fruits, vegetables, lean proteins, and whole grains while reducing processed foods and sugars.$disclaimer';
    } else if (msg.contains('sleep') || msg.contains('insomnia')) {
      reply =
          'To improve sleep, establish a regular schedule, limit screen time before bed, and ensure a comfortable, dark environment.$disclaimer';
    } else if (msg.contains('exercise') || msg.contains('fitness')) {
      reply =
          'Aim for at least 150 minutes of moderate aerobic activity per week, along with strength training exercises twice a week.$disclaimer';
